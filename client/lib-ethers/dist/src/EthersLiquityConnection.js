...
const convertToDate = (timestamp) => new Date((typeof timestamp === "number" ? timestamp : timestamp.toNumber()) * 1000);
...
const _getBlockTimestamp = (connection, blockTag = "latest") => {
    ...
    return ((_b = (_a = getMulticall(connection)) === null || _a === void 0 ? void 0 : _a.getCurrentBlockTimestamp({ blockTag })) !== null && _b !== void 0 ? _b : exports._getProvider(connection).getBlock(blockTag).then(getTimestampFromBlock)).then(convertToDate);
};
