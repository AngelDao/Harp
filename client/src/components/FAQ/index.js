        ...
        <Desc>
          <TokenomicsList>
            ...
            <li>
              ...
              and 20% of tokens will be rewarded to the Profit Share pool.
            </li>
            <li>
              <b>25%</b> of supply will go to Liquidity Mining. 80% going to the
              gSTRING/ETH and 20% going to gSTRING/LUSD
            </li>
          </TokenomicsList>
        </Desc>
        <HR />
