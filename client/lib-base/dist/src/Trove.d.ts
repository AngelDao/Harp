...
/** @internal */ export declare type _LUSDBorrowing<T> = {
    borrowLUSD: T;
};
/** @internal */ export declare type _LUSDRepayment<T> = {
    repayLUSD: T;
};
...
/** @internal */ export declare type _NoLUSDBorrowing = Partial<_LUSDBorrowing<undefined>>;
/** @internal */ export declare type _NoLUSDRepayment = Partial<_LUSDRepayment<undefined>>;
/** @internal */
...
/** @internal */
export declare type _DebtChange<T> = (_LUSDBorrowing<T> & _NoLUSDRepayment) | (_LUSDRepayment<T> & _NoLUSDBorrowing);
/** @internal */
export declare type _NoDebtChange = _NoLUSDBorrowing & _NoLUSDRepayment;
/**
