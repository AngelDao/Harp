const SortedTroves = artifacts.require("./Liquity/SortedTroves.sol");
const TroveManager = artifacts.require("./Liquity/TroveManager.sol");
const PriceFeedTestnet = artifacts.require("./Liquity/PriceFeedTestnet.sol");
const LUSDToken = artifacts.require("./Liquity/LUSDToken.sol");
const ActivePool = artifacts.require("./Liquity/ActivePool.sol");
const DefaultPool = artifacts.require("./Liquity/DefaultPool.sol");
const StabilityPool = artifacts.require("./Liquity/StabilityPool.sol");
const GasPool = artifacts.require("./Liquity/GasPool.sol");
const CollSurplusPool = artifacts.require("./Liquity/CollSurplusPool.sol");
const FunctionCaller = artifacts.require(
  "./Liquity/TestContracts/FunctionCaller.sol"
);
const BorrowerOperations = artifacts.require(
  "./Liquity/BorrowerOperations.sol"
);
const HintHelpers = artifacts.require("./Liquity/HintHelpers.sol");

const LQTYStaking = artifacts.require("./Liquity/LQTYStaking.sol");
const LQTYToken = artifacts.require("./Liquity/LQTYToken.sol");
const LockupContractFactory = artifacts.require(
  "./Liquity/LockupContractFactory.sol"
);
const CommunityIssuance = artifacts.require("./Liquity/CommunityIssuance.sol");

const Unipool = artifacts.require("./Liquity/Unipool.sol");

const LQTYTokenTester = artifacts.require("./Liquity/LQTYTokenTester.sol");
const CommunityIssuanceTester = artifacts.require(
  "./Liquity/CommunityIssuanceTester.sol"
);
const StabilityPoolTester = artifacts.require(
  "./Liquity/StabilityPoolTester.sol"
);
const ActivePoolTester = artifacts.require("./Liquity/ActivePoolTester.sol");
const DefaultPoolTester = artifacts.require("./Liquity/DefaultPoolTester.sol");
const LiquityMathTester = artifacts.require("./Liquity/LiquityMathTester.sol");
const BorrowerOperationsTester = artifacts.require(
  "./Liquity/BorrowerOperationsTester.sol"
);
const TroveManagerTester = artifacts.require(
  "./Liquity/TroveManagerTester.sol"
);
const LUSDTokenTester = artifacts.require("./Liquity/LUSDTokenTester.sol");
